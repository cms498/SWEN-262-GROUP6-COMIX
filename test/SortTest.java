...
public class SortTest {
    ...
    public List<Comic> setUp() {
        ...
        Comic comic = new Comic(publisher, "Spider-Man", "SPIDER_MAN_TITLE", 0, "2", "Jun 1986", creators, "A good book", 26.08, false, false, signatures, false, 0);
        Comic comic2 = new Comic(publisher2, "Batman", "BATMAN", 1, "1", "Jun 10, 2015", creators, "MID", 0, false, false, signatures, false, 0);
        Comic comic3 = new Comic(publisher, "ANT_MAN", "ANT_MAN", 2, "3", "Jul 29, 2015", creators, "also very mid", 0, false, false, signatures, false, 0);
